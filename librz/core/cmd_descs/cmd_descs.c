...
static const RzCmdDescDetailEntry pf_Example_space_of_space_usages_detail_entries[] = {
	...
	{ .text = "pf 'obj xxdz prev next size name'", .arg_str = NULL, .comment = "Define the obj format as xxdz" },
	{ .text = "pf. 'plop ? (troll)mystruct'", .arg_str = NULL, .comment = "Use previously defined structure 'troll'" },
	{ .text = "pfj. plop @ 0x14", .arg_str = NULL, .comment = "Apply format object at the given offset" },
	...
	{ .text = "pf .foo rr (eax)reg1 (eip)reg2", .arg_str = NULL, .comment = "Create obect referencing to register values" },
...
RZ_IPI void rzshell_cmddescs_init(RzCore *core) {
	...
	RzCmdDesc *cmd_print_format_named_cd = rz_cmd_desc_argv_state_new(core->rcmd, pf_cd, "pf.", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_QUIET, rz_cmd_print_format_named_handler, &cmd_print_format_named_help);
